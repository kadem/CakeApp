 ...
 */
package com.tutsplus.opengltutorial.view;
...
public class ColorPickerView extends View {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		TypedArray a = getContext().obtainStyledAttributes(attrs, com.github.danielnilsson9.colorpickerview.R.styleable.colorpickerview__ColorPickerView);
		mShowAlphaPanel = a.getBoolean(com.github.danielnilsson9.colorpickerview.R.styleable.colorpickerview__ColorPickerView_alphaChannelVisible, false);
		mAlphaSliderText = a.getString(com.github.danielnilsson9.colorpickerview.R.styleable.colorpickerview__ColorPickerView_alphaChannelText);
		mSliderTrackerColor = a.getColor(com.github.danielnilsson9.colorpickerview.R.styleable.colorpickerview__ColorPickerView_sliderColor, 0xFFBDBDBD);
		mBorderColor = a.getColor(com.github.danielnilsson9.colorpickerview.R.styleable.colorpickerview__ColorPickerView_borderColor, 0xFF6E6E6E);
		a.recycle();
		...
		mRequiredPadding = getResources().getDimensionPixelSize(com.github.danielnilsson9.colorpickerview.R.dimen.colorpickerview__required_padding);
